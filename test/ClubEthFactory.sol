...
// ClubEthToken
// ----------------------------------------------------------------------------
contract ClubEthToken is ClubEthTokenInterface, Owned {
...
contract ClubEth {
    ...
    ClubEthTokenInterface public token;
    ...
    constructor(string clubName, address clubEthToken, uint _tokensForNewMembers) public {
        members.init();
        name = clubName;
...
contract ClubEthFactory is Owned {
    ...
    function deployClubEthContract(
        ...
        club = new ClubEth(clubName, address(token), tokensForNewMembers);
        ...
        emit ClubEthListing(address(club), clubName, address(token), tokenSymbol, tokenName, tokenDecimals, msg.sender, tokensForNewMembers);
    }
